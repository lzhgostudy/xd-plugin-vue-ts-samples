import { Line as ILine, Color as IColor, Selection, SceneNode } from "scenegraph"
...
export default function createLinesHandlerFunction(selection: Selection) {
  let lines: SceneNode[] = [];

  lineData.forEach(data => {
    const line:ILine = new Line();
    line.setStartEnd(
      data.startX,
      data.startY,
      data.endX,
